...
coverage: ## check code coverage quickly with the default Python
	coverage run --source excel_generator setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/excel_generator.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ excel_generator
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pep8 --statistics excel_generator tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes excel_generator tests
